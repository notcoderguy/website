...
<body class="h-full">
    ...
    <div class="bg-secondary-400 min-h-full flex flex-col lg:relative">
        <div class="flex-grow flex flex-col">
            <main class="flex-grow flex flex-col bg-secondary-400">
                <div class="flex-grow mx-auto max-w-7xl w-full flex flex-col px-4 sm:px-6 lg:px-8">
                    ...
                    <div class="flex-shrink-0 my-auto py-16 sm:py-32">
                        <p class="text-sm font-semibold text-primary uppercase tracking-wide">@yield('code') error</p>
                        <h1 class="mt-2 text-4xl font-extrabold text-gray-400 tracking-tight sm:text-5xl">@yield('message')
                        </h1>
                        <div class="mt-6">
