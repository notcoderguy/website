...
<div class="flex flex-col justify-center min-h-screen py-12 bg-secondary-300 sm:px-6 lg:px-8">
    <div class="sm:mx-auto sm:w-full sm:max-w-md">
        ...
        <p class="mt-2 text-sm text-center text-gray-400 leading-5 max-w">
            Or
            <a href="{{ route('login') }}" class="font-medium text-primary hover:text-indigo-500 focus:outline-none focus:underline transition ease-in-out duration-150">
    ...
    <div class="mt-8 sm:mx-auto sm:w-full sm:max-w-md">
        <div class="px-4 py-8 bg-secondary-400 shadow sm:rounded-lg sm:px-10">
            <form wire:submit.prevent="register">
                <div>
                    <label for="name" class="block text-sm font-medium text-gray-400 leading-5">
                        Name
                    </label>
                ...
                <div class="mt-6">
                    <label for="email" class="block text-sm font-medium text-gray-400 leading-5">
                        Email address
                    </label>
                ...
                <div class="mt-6">
                    <label for="password" class="block text-sm font-medium text-gray-400 leading-5">
                        Password
                    </label>
                ...
                <div class="mt-6">
                    <label for="password_confirmation" class="block text-sm font-medium text-gray-400 leading-5">
                        Confirm Password
                    </label>
                ...
                <div class="mt-6">
                    <span class="block w-full rounded-md shadow-sm">
                        <button type="submit" class="flex justify-center w-full px-4 py-2 text-sm font-medium text-secondary-400 bg-primary border border-transparent rounded-md hover:bg-indigo-500 focus:outline-none focus:border-indigo-600 focus:ring-indigo active:bg-indigo-600 transition duration-150 ease-in-out">
                            Register
                        </button>
                    </span>
                </div>
