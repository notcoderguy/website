    ...
    <footer class="bg-secondary-400">
        <div class="max-w-7xl mx-auto py-12 px-4 overflow-hidden sm:px-6 lg:px-8">
            ...
            <div class="mt-8 flex justify-center space-x-6">
                ...
                <a href="https://twitter.com/not_coder_guy/" target="_blank" class="text-gray-400 hover:text-primary">
                ...
                <a href="https://github.com/notcoderguy/" target="_blank" class="text-gray-400 hover:text-primary">
