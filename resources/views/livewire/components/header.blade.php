<div id="header" class="relative bg-gray-100 dark:bg-secondary-400" data-turbo-permanent>
    <div class="flex justify-between items-center px-4 py-6 sm:px-6 md:justify-start md:space-x-10">
        <div class="flex justify-start lg:w-0 lg:flex-1">
            <a href="{{ route('home') }}" data-turbo-preload>
        ...
        <div class="md:flex items-center justify-end md:flex-1 lg:w-0">
            <button id="theme-toggle" type="button"
                class="text-secondary-200 dark:text-gray-300 bg-gray-300 hover:bg-gray-200  dark:bg-secondary-200 dark:hover:bg-secondary-100 focus:outline-none focus:ring-4 focus:ring-gray-200 dark:focus:ring-gray-700 rounded-lg text-sm p-2.5">
                <div class="moon">
